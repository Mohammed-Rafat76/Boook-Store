...
export default function Review() {
  return (
    <div className="bg-white py-4 px-6 flex flex-col justify-center items-start gap-4">
      ...
      <div className="flex flex-col gap-2 justify-center items-start">
        <div className="text-[20px] font-semibold text-[#222222] flex justify-start gap-4 items-center">
          <h1 className="w-65">Excellent Book</h1>
          <h1>5.0</h1>
        ...
        <p className="font-normal text-[18px] text-[#22222280]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et ultricies est. Aliquam in justo varius, sagittis neque ut, </p>
      </div>
    </div>
  );
}
