  ...
  return (
    <div>
      ...
      <nav className="w-full absolute top-0 bg-white/20 text-white h-10 md:h-14 lg:h-23 flex items-center justify-between py-6 xl:px-35 lg:px-30 md:px-20 px-5">
        ...
        <Link
          to={"/"}
          className="group flex items-center justify-start xl:w-11 lg:w-10 w-7  xl:h-11 lg:h-10 h-7  bg-red-600 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1"
        >
