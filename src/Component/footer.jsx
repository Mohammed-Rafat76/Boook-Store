...
export default function Footer() {
  return (
    <div className="bg-[#3B2F4A] flex justify-center items-center w-full lg:h-92.5 h-100 lg:px-15 px-5">
        ...
        <div className=" w-full flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0">
          <div className="flex items-center justify-center gap-10 ">
            ...
            <div className="flex items-center justify-center lg:gap-6 gap-4">
              <h1 className="lg:font-semibold font-medium lg:text-[16px] text-[14px]">Home</h1>
              <h1 className="lg:font-semibold font-medium lg:text-[16px] text-[14px]">Books</h1>
              <h1 className="lg:font-semibold font-medium lg:text-[16px] text-[14px]">About us</h1>
            </div>
          </div>
